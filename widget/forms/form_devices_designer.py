...
# Form implementation generated from reading ui file 'form_devices.ui'
#
...
class Ui_FormDevices(object):
    def setupUi(self, FormDevices):
        FormDevices.setObjectName("FormDevices")
        FormDevices.resize(1060, 500)
        FormDevices.setStyleSheet("background-color: rgb(27, 29, 35);")
        FormDevices.setWindowFlag(QtCore.Qt.FramelessWindowHint)
        self.frame_main = QtWidgets.QFrame(FormDevices)
        self.frame_main.setGeometry(QtCore.QRect(0, 0, 1062, 500))
        self.frame_main.setMinimumSize(QtCore.QSize(1060, 500))
        ...
        self.frame_header.setMinimumSize(QtCore.QSize(1050, 42))
        ...
        QtCore.QMetaObject.connectSlotsByName(FormDevices)

    def retranslateUi(self, FormDevices):
