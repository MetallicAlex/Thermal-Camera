...
# Form implementation generated from reading ui file 'messagebox_department.ui'
#
...
class Ui_DepartmentMessageBox(object):
    def setupUi(self, DepartmentMessageBox):
        DepartmentMessageBox.setObjectName("DepartmentMessageBox")
        ...
        self.lineEdit_department = QtWidgets.QLineEdit(self.frame_contains)
        self.lineEdit_department.setGeometry(QtCore.QRect(60, 40, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(8)
        ...
        self.button_accept.setGeometry(QtCore.QRect(60, 90, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.retranslateUi(DepartmentMessageBox)
        QtCore.QMetaObject.connectSlotsByName(DepartmentMessageBox)
